...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Líneas de idioma utilizadas por el validador de Laravel. Se traducen
    | las reglas estándar al español neutro/latinoamericano para mensajes
    | de error coherentes con la UI. Los placeholders :attribute, :min,
    | :max, :other, :value, :values, :date, :format, :size, :digits
    | son reemplazados por Laravel en tiempo de ejecución.
    |
    */
    ...
    'decimal' => 'El campo :attribute debe tener :decimals decimales.',
    ...
    'missing_with' => 'El campo :attribute no debe estar presente cuando alguno de :values esté presente.',
    'missing_with_all' => 'El campo :attribute no debe estar presente cuando todos :values estén presentes.',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Reemplaza el placeholder :attribute por etiquetas legibles en español
    | para los nombres de campos del proyecto. El validador intenta primero
    | estos overrides antes de generar el nombre "humano" a partir del slug.
    |
    */
    ...
    'attributes' => [
        ...
        'signature_code' => 'código de firma',
        'code' => 'código',
        'name' => 'nombre',
