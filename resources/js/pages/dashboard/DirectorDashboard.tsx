import { ClipboardCheck, FolderKanban, FileText } from 'lucide-react';

const cards = [
    {
        icon: FolderKanban,
        title: 'Proyectos Activos',
        description: 'Proyectos de grado bajo tu dirección',
        status: 'Próximamente',
        color: 'text-primary',
    ...
    },
    {
        ...
        description: 'Trabajos pendientes por revisar',
        status: 'Próximamente',
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-text">Panel de Director</h1>
                    <p className="mt-1 text-sm text-text-muted">Supervisa proyectos de grado</p>
                </div>
            </div>
